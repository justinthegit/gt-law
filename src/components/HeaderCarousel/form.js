					...
					{({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
						<FormWrapper formOpen={this.props.formOpen}>
							...
							<FormWrap isSubmitted={this.state.isSubmitted} onSubmit={handleSubmit}>
								...
								<p>
								Gilbert + Tobin (G+T) understands that privacy and how we collect, use, disclose and protect your information is important to you. <a  target="_blank" href="https://www.gtlaw.com.au/privacy-policy">Privacy Policy</a>.
								</p>
